@echo off
REM Build script for SS14 FTL Translator - Creates a single EXE file

setlocal enabledelayedexpansion

echo.
echo ========================================
echo SS14 FTL Translator - Build Script
echo ========================================
echo.
...
echo ========================================
echo.
echo Output: .\dist\SS14Translator.exe
...
echo 3. Run: .\dist\SS14Translator.exe
echo.
pause
